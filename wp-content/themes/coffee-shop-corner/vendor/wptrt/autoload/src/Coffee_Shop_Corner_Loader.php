...
class Coffee_Shop_Corner_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function coffee_shop_corner_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function coffee_shop_corner_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function coffee_shop_corner_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function coffee_shop_corner_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->coffee_shop_corner_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function coffee_shop_corner_load( $class ) {
