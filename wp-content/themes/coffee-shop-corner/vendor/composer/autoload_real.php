...
class Coffee_Shop_Corner_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function coffee_shop_corner_loadClassLoader($class)
    {
    ...
    public static function coffee_shop_corner_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
