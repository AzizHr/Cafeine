...
<div class="container">
	...
	<div class="content-area">
		<main id="skip-content" class="site-main" role="main">
			<?php
		    $coffee_shop_corner_archive_page_sidebar = get_theme_mod('coffee_shop_corner_archive_page_sidebar','One Column');
		    if($coffee_shop_corner_archive_page_sidebar == 'Left Sidebar'){ ?>
		    	<div class="row">
			...
			<?php }else if($coffee_shop_corner_archive_page_sidebar == 'Right Sidebar'){ ?>
				<div class="row">
					<div class="content_area col-lg-8 col-md-8">
						<section id="post_section">
							<div class="row">
			...
			<?php }else if($coffee_shop_corner_archive_page_sidebar == 'One Column'){ ?>
			...
			<?php }else if($coffee_shop_corner_archive_page_sidebar == 'Grid Layout'){ ?>
		    	<div class="content_area">
					<section id="post_section" >
						<div class="row">
							<?php
